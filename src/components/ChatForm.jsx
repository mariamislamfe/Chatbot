...
setTimeout(() => {
    ...
    const thinkingInterval = setInterval(() => {
        ...
        setChatHistory(history => {
            ...
            const newHistory = history.filter(msg => !msg.id || msg.id !== thinkingMsgId);
            return [...newHistory, {role: "model", text: thinkingText, id: thinkingMsgId}];
        });
    }, 300);
    ...
    generateBotResponse([...chatHistory, {role: "user", text: userMessage}])
        .then(() => {
            ...
            setChatHistory(history => history.filter(msg => !msg.id || msg.id !== thinkingMsgId));
